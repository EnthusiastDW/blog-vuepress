...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
        ...
        items: [
          {
            text: '学习笔记',
            items: [
              {text: 'JavaScript笔记', link: '/front/javascript/'},
            ]
          },
        ]
      },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: '前端博客,个人技术博客,前端,前端开发,前端框架,web前端,前端面试题,技术文档,学习,面试,JavaScript,js,markdown,后端,后端框架,01.java,mysql,mq,redis,postgresql,spring,spring boot,linux',
      },
    ],
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: 'Ov23liY4oNR8EksIrSfo',
          clientSecret: '83fcb88052cb604836562b9ee5e6bb377e715ed8',
          repo: 'gitalk-comments', // GitHub 仓库
          owner: 'EnthusiastDW', // GitHub仓库所有者
          admin: ['EnthusiastDW'], // 对仓库有写权限的人
